 ...
 * }
 */
router.post('/llm/chat', requireApiKey, requireEndpoint('llm:chat'), asyncHandler(async (req, res) => {
 ...
 */
router.get('/llm/job/:jobId', requireApiKey, requireEndpoint('llm:status'), asyncHandler(async (req, res) => {
 ...
 */
router.get('/llm/queue', requireApiKey, requireEndpoint('llm:status'), asyncHandler(async (req, res) => {
 ...
 */
router.get('/models', requireApiKey, requireEndpoint('llm:status'), asyncHandler(async (req, res) => {
 ...
 */
router.post('/api-keys', requireAuth, asyncHandler(async (req, res) => {
 ...
 */
router.delete('/api-keys/:keyId', requireAuth, asyncHandler(async (req, res) => {
    const result = await require('../database').query(`
        UPDATE api_keys
        SET is_active = false
