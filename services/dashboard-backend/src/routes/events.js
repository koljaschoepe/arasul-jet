...
const { ValidationError, NotFoundError, UnauthorizedError, ForbiddenError, ServiceUnavailableError } = require('../utils/errors');
 ...
 */
router.post('/webhook/n8n', asyncHandler(async (req, res) => {
 ...
 */
router.post('/webhook/self-healing', asyncHandler(async (req, res) => {
 ...
 */
router.get('/service-status', auth, asyncHandler(async (req, res) => {
    const result = await db.query(`
 ...
 */
router.get('/boot-history', auth, asyncHandler(async (req, res) => {
 ...
 */
router.post('/cleanup', auth, asyncHandler(async (req, res) => {
 ...
 */
router.get('/telegram/status', auth, asyncHandler(async (req, res) => {
    const connectionTest = await telegramService.testConnection();
