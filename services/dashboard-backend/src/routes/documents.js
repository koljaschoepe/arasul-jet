 ...
 */
router.post('/:id/reindex', requireAuth, asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 */
router.get('/:id/similar', requireAuth, asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 */
router.get('/:id/content', requireAuth, asyncHandler(async (req, res) => {
    const { id } = req.params;
 ...
 */
router.put('/:id/content', requireAuth, asyncHandler(async (req, res) => {
    const { id } = req.params;
