 ...
 */
router.post('/config', requireAuth, apiLimiter, asyncHandler(async (req, res) => {
 ...
 */
router.get('/updates', requireAuth, testLimiter, asyncHandler(async (req, res) => {
    ...
    try {
        ...
        if (axiosError.response && axiosError.response.data) {
            ...
            throw new ValidationError(`Telegram API error: ${telegramError.description || 'Unknown error'}`);
        }
        throw axiosError;
    }
 ...
 */
router.put('/thresholds', requireAuth, apiLimiter, asyncHandler(async (req, res) => {
 ...
 */
router.post('/test', requireAuth, testLimiter, asyncHandler(async (req, res) => {
    ...
    if (!chatId) {
        throw new ValidationError('Chat ID is required. Provide it in the request or configure a default.');
    }
    ...
    let response;
    try {
        response = await axios.post(telegramApiUrl, {
            chat_id: chatId,
            text: testMessage,
            parse_mode: 'HTML'
        }, {
 ...
 */
router.get('/audit-logs/stats', requireAuth, asyncHandler(async (req, res) => {
 ...
 */
router.get('/audit-logs/user/:userId', requireAuth, asyncHandler(async (req, res) => {
 ...
 */
router.delete('/audit-logs/cleanup', requireAuth, asyncHandler(async (req, res) => {
 ...
 */
router.get('/audit-logs/:id', requireAuth, asyncHandler(async (req, res) => {
    const { id } = req.params;
