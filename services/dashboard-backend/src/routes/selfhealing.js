...
router.get('/recovery-actions', requireAuth, asyncHandler(async (req, res) => {
...
router.get('/service-failures', requireAuth, asyncHandler(async (req, res) => {
...
router.get('/reboot-history', requireAuth, asyncHandler(async (req, res) => {
