...
import { FiPlus, FiSearch, FiGrid, FiList, FiDatabase, FiFileText, FiRefreshCw } from 'react-icons/fi';
...
const CreateTableModal = memo(function CreateTableModal({ isOpen, onClose, onCreated }) {
    ...
    const icons = ['📦', '📊', '📋', '📝', '💼', '🛒', '👥', '🏢', '📁', '🔧', '💰', '📅'];
    const colors = ['#45ADFF', '#22C55E', '#F59E0B', '#EF4444', '#8B5CF6', '#06B6D4', '#EC4899', '#14B8A6'];
    ...
    return (
        <Link to={`/database/${table.slug}`} className="dt-table-card">
            ...
            <div className="dt-table-card-content">
                ...
                {table.description && (
                    <p className="dt-table-card-description">{table.description}</p>
                )}
                ...
                <div className="dt-table-card-meta">
    ...
    const fetchTables = useCallback(async () => {
        ...
        try {
            ...
            const response = await axios.get(
                `${API_BASE}/v1/datentabellen/tables`,
