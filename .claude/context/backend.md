...
- **Main App**: `apps/dashboard-backend/src/index.js`
- **Server**: `apps/dashboard-backend/src/server.js`
- **Routes**: `apps/dashboard-backend/src/routes/` (31 files)
- **Services**: `apps/dashboard-backend/src/services/` (13 files)
