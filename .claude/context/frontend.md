...
- **Main App**: `apps/dashboard-frontend/src/App.js`
- **Components**: `apps/dashboard-frontend/src/components/`
- **Tests**: `apps/dashboard-frontend/src/__tests__/`
- **Styles**: `apps/dashboard-frontend/src/*.css`
