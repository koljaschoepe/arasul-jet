 ...
 * Modell-Aufrufe, geteilt zwischen Chat und Flows.
 *
 ...
 * llmQueueService (ein Job zur Zeit). Ein Flow-Lauf ist aber ein ZWEITER
 * Aufrufer der GPU; ohne eine GEMEINSAME Sperre könnten ein Chat-Aufruf und ein
 * Flow-Aufruf zugleich auf die GPU treffen (llmQueueService und das frühere
 ...
 * Auslöser für Flows, kein eigener Dauerbetrieb.
 *
 * Deshalb geht der EIGENTLICHE Ollama-Aufruf des Chats (streamFromOllama in
 * services/llm/llmOllamaStream.js) durch DIESELBE Sperre wie die Flow-Aufrufe.
 ...
 * Ende ist, beim Flow bis der eine Modell-Aufruf zurück ist. Cloud-Provider
