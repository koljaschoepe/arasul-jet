/**
 * Flow-Werkzeuge für die Web-Recherche (Plan 011, Schritt 8).
 *
 * Zwei Werkzeuge, getrennt wie bei den Dateien: `web_suche` findet Adressen,
 * `web_lesen` holt eine davon. Ein Flow kann suchen dürfen, ohne beliebige
 ...
 * Netz und erreicht Postgres und den Docker-Proxy. Ein Werkzeug,
