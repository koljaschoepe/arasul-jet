/**
 * Reine Helfer für die Flow-Lauf-Registry im ChatContext (Plan 011, Schritt 15).
 *
 ...
 */
export function addFlowRun(vorhanden: number[], runId: number | string): number[] {
 ...
 */
export function mergeFlowRuns(vorhanden: number[], serverIds: (number | string)[]): number[] {
