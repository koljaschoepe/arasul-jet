...
const ABSCHNITTE: FilterBarItem<Section>[] = [
  { id: 'llm', label: 'Arasul LLM Node', icon: Cpu },
  { id: 'embeddings', label: 'Arasul Embeddings Node', icon: Binary },
  { id: 'documents', label: 'Arasul Documents Node', icon: FileText },
  { id: 'http', label: 'HTTP Request (Direkt)', icon: Globe },
];
...
export function N8nIntegrationGuide() {
              ...
              <div className="space-y-4">
                <div className="border-l-2 border-primary/30 pl-4">
                  <p className="text-xs text-muted-foreground">
                    ...
                    vorinstalliert und bietet direkten Zugriff auf das lokale KI-Modell. Dies ist
                    der einfachste Weg, KI in deine Workflows einzubauen.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border border-border/50 rounded-lg p-3 space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Für einfache Textvervollständigung ohne Chat-Format. Parameter: Model,
                        Prompt, Stream.
                      </p>
                    </div>
  ...
  "latency_ms": 45
            ...
            {activeSection === 'documents' && (
              <div className="space-y-4">
                <div className="border-l-2 border-primary/30 pl-4">
                  <p className="text-xs text-muted-foreground">
                    Der <strong className="text-foreground">Arasul Documents</strong> Node
                    extrahiert Text aus Dokumenten (PDF, DOCX, Bilder mit OCR) und kann sie optional
                    per KI analysieren. Ideal für Rechnungsverarbeitung, E-Mail-Anhänge und
                    Formularextraktion.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mb-2">
                    Erstelle eine <strong>Arasul Documents API</strong> Credential. Du benötigst
                    einen API-Key (erstellen unter <strong>Sicherheit &gt; API-Keys</strong>):
                  </p>
                  <div className="border border-border/50 rounded-lg divide-y divide-border/50">
                    <CredentialRow
                      label="API Base URL"
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border border-border/50 rounded-lg p-3 space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Extrahiert strukturierte JSON-Daten nach einem Schema. Perfekt für
                        Rechnungen, Formulare und Bestellungen. Gib ein JSON-Schema vor und erhalte
  ...
  "texts": ["Dein Text für die Vektorisierung"]
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mb-2">
                    Suche in indexierten Dokumenten per Vektor. Kombiniere mit dem
                    Embedding-Endpunkt für eine eigene Suchpipeline.
                  </p>
                  <p className="text-xs text-muted-foreground mb-2">
                    HTTP Request Node: <strong>POST</strong>{' '}
                    <code className="font-mono bg-muted/50 px-1 py-0.5 rounded">
