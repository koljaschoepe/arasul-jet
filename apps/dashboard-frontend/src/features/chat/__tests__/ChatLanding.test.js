 ...
 *
 * Tests fuer die Chat-Uebersichtsseite:
...
describe('ChatLanding Component', () => {
  ...
  // =====================================================
  describe('Suche', () => {
    test('Suche loest API-Aufruf aus (debounced)', async () => {
    ...
    test('Suche-Leeren-Button setzt Suche zurueck', async () => {
      const user = userEvent.setup({ advanceTimers: jest.advanceTimersByTime });
      render(<ChatLanding />);
  ...
  describe('Filter-Chips', () => {
    test('zeigt Filter-Chips fuer Projekte', async () => {
      render(<ChatLanding />);
  ...
  describe('Neues Projekt', () => {
    test('oeffnet Modal bei Klick auf Neues-Projekt', async () => {
      const user = userEvent.setup({ advanceTimers: jest.advanceTimersByTime });
      render(<ChatLanding />);
