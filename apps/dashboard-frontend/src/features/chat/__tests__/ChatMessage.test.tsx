 ...
 *
 * Tests für die ChatMessage-Komponente:
...
describe('ChatMessage Component', () => {
  ...
  describe('Thinking-Block', () => {
    test('zeigt Thinking-Block wenn hasThinking und thinking vorhanden', () => {
      const message = {
        ...
        content: 'Antwort',
        hasThinking: true,
        thinking: 'Ich denke über die Frage nach...',
      ...
      expect(screen.getByText('Ich denke über die Frage nach...')).toBeInTheDocument();
    });
  ...
  describe('Markdown-Inhalt', () => {
    test('rendert Markdown über ReactMarkdown', () => {
      ...
      expect(markdownContainer.textContent).toContain('# Überschrift');
    });
    ...
    const sourcesMessage = {
      ...
      sources: [
        ...
        },
        {
          ...
          text_preview: 'Häufig gestellte Fragen...',
          score: 0.82,
        },
      ],
  ...
  describe('Edge Cases', () => {
    ...
    test('behandelt Source mit Score=1 korrekt', () => {
      const message = {
        ...
        content: 'Antwort',
        sources: [
          { document_name: 'Perfekt.pdf', text_preview: 'Exakte Übereinstimmung', score: 1.0 },
        ],
        sourcesCollapsed: false,
      };
