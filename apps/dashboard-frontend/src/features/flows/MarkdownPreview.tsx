...
interface MarkdownPreviewProps {
  /** Der API-Body (aus flowForm.toBody) — die Eingaben in Roh-Form. */
...
export default function MarkdownPreview({ body, defaultView = 'datei' }: MarkdownPreviewProps) {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      const endpoint = view === 'datei' ? '/flows/vorschau' : '/flows/vorschau-laufzeit';
      api
