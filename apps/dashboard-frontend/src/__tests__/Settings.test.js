...
jest.mock('../features/system/UpdatePage', () => () => (
  <div data-testid="update-page">Update Page Content</div>
));
jest.mock('../features/system/SelfHealingEvents', () => () => (
  <div data-testid="selfhealing-events">Self-Healing Events Content</div>
));
jest.mock('../features/settings/PasswordManagement', () => () => (
  <div data-testid="password-management">Password Management Content</div>
));
