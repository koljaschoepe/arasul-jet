...
describe('ConfirmIconButton Component', () => {
  ...
  describe('Variants', () => {
    ...
    test('hat warning variant', () => {
      const { container } = render(<ConfirmIconButton {...defaultProps} variant="warning" />);

      expect(container.querySelector('.btn-icon-warning')).toBeInTheDocument();
    });

    test('hat primary variant', () => {
      const { container } = render(<ConfirmIconButton {...defaultProps} variant="primary" />);
  ...
  describe('Different Props', () => {
    test('zeigt custom confirmText', async () => {
      const user = userEvent.setup();
      render(<ConfirmIconButton {...defaultProps} confirmText="Service stoppen?" />);
    ...
    test('zeigt custom label im tooltip', () => {
      render(<ConfirmIconButton {...defaultProps} label="Service neustarten" />);
