...
| `N8N_SSRF_ALLOWED_HOSTNAMES=llm-service,dashboard-backend,embedding-service,document-indexer`                                                            | n8n         | Interne Dienste, die Workflows legitim brauchen. **postgres-db ist bewusst nicht freigegeben.** Allowlist schlägt Blocklist.                                                                                                                                                                                                      |
