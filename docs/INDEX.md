...
| [DEPLOYMENT_CHECKLIST.md](DEPLOYMENT_CHECKLIST.md)               | Pre-shipping verification checklist |
...
| [REMOTE_MAINTENANCE.md](REMOTE_MAINTENANCE.md)                   | Fernwartung (SSH, Cloudflare, VPN)  |
...
| Document                                 | Description                          |
| ---------------------------------------- | ------------------------------------ |
| [QUICK_START.md](QUICK_START.md)         | Schnellstart-Anleitung (1 Seite)     |
| [ADMIN_HANDBUCH.md](ADMIN_HANDBUCH.md)   | Administrationshandbuch (12 Kapitel) |
| [TROUBLESHOOTING.md](TROUBLESHOOTING.md) | Fehlerbehebung & Support             |
