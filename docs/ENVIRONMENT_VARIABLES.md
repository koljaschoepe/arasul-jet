...
| Variable               | Default                              | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ---------------------- | ------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| MDNS_NAME              | arasul                               | Der Netzname des Geräts, ohne `.local`. Er ist der System-Hostname (den der Router per DHCP lernt, daher `https://arasul/`), der Avahi-Name (`https://arasul.local/`), der Name im Gerätezertifikat und die Antwort von `GET /api/system/network`. Bei der Installation über `./install.sh --name <name>`, nachträglich über `sudo MDNS_NAME=<name> bash scripts/setup/setup-mdns.sh` plus `./arasul zertifikat`. Siehe [ops/NETZNAME_UND_ZERTIFIKAT.md](ops/NETZNAME_UND_ZERTIFIKAT.md) |
