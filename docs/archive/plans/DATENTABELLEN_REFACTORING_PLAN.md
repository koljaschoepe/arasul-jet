...
| ------------------------------------------------------------ | ------- | ------------------------------------------ |
| `apps/dashboard-frontend/src/components/YamlGridEditor.js`   | Löschen | YAML-Grid nicht mehr benötigt              |
| `apps/dashboard-frontend/src/components/YamlCreateDialog.js` | Löschen | YAML-Erstellungsdialog nicht mehr benötigt |
| `apps/dashboard-frontend/src/yamltable.css`                  | Löschen | Zugehörige Styles                          |

### 1.2 Backend-Dateien entfernen

| Datei                                                     | Aktion  | Begründung         |
| --------------------------------------------------------- | ------- | ------------------ |
| `apps/dashboard-backend/src/routes/yamlTables.js`         | Löschen | YAML-API-Routes    |
| `apps/dashboard-backend/src/services/yamlQueryService.js` | Löschen | YAML-Query-Service |
...
- `apps/dashboard-frontend/src/components/shared/GridEditor/CellEditor.js`
- `apps/dashboard-frontend/src/components/shared/GridEditor/DataCell.js`
- `apps/dashboard-frontend/src/components/shared/GridEditor/FieldTypes.js`
- `apps/dashboard-frontend/src/components/shared/GridEditor/index.js`
...
**Datei:** `apps/dashboard-frontend/src/components/Database/ExcelEditor.js`
...
**Datei:** `apps/dashboard-frontend/src/components/Database/InlineColumnCreator.js`
...
**Datei:** `apps/dashboard-frontend/src/components/Database/ExcelKeyboardHandler.js`
...
**Datei:** `apps/dashboard-backend/src/services/llmDataAccessService.js`
...
const handleCellSave = useCallback(
  (rowId, fieldSlug, newValue, direction) => {
...
const VirtualizedGrid = memo(function VirtualizedGrid({ rows, fields, rowHeight = 32 }) {
  const Row = ({ index, style }) => {
    ...
    return (
      <div style={style} className="excel-row">
        {fields.map(field => (
          <ExcelCell key={field.slug} row={row} field={field} />
        ))}
      </div>
    );
  };
  ...
  return (
    <List height={window.innerHeight - 120} itemCount={rows.length} itemSize={rowHeight}>
      {Row}
    </List>
  );
});
...
```javascript
// Debounced Search
const debouncedSearch = useMemo(() => debounce(query => fetchRows(1, query), 300), [fetchRows]);
...
- `apps/dashboard-frontend/src/components/YamlGridEditor.js`
- `apps/dashboard-frontend/src/components/YamlCreateDialog.js`
- `apps/dashboard-frontend/src/yamltable.css`
- `apps/dashboard-backend/src/routes/yamlTables.js`
- `apps/dashboard-backend/src/services/yamlQueryService.js`

### Neue Dateien:

- `apps/dashboard-frontend/src/components/Database/ExcelEditor.js`
- `apps/dashboard-frontend/src/components/Database/ExcelGrid.js`
- `apps/dashboard-frontend/src/components/Database/ExcelToolbar.js`
- `apps/dashboard-frontend/src/components/Database/ExcelCell.js`
- `apps/dashboard-frontend/src/components/Database/InlineColumnCreator.js`
- `apps/dashboard-frontend/src/components/Database/ColumnMenu.js`
- `apps/dashboard-frontend/src/components/Database/CellContextMenu.js`
- `apps/dashboard-frontend/src/components/Database/ExcelKeyboardHandler.js`

### Zu modifizierende Dateien:

- `apps/dashboard-frontend/src/App.js` - YAML-Imports entfernen
- `apps/dashboard-frontend/src/components/Database/Database.css` - Neue Styles
- `apps/dashboard-frontend/src/index.css` - Layout-Fixes
- `apps/dashboard-backend/src/index.js` - YAML-Route entfernen
- `apps/dashboard-backend/src/services/llmDataAccessService.js` - SQL-Generation
...
_Plan erstellt: 07.02.2026_
_Letzte Aktualisierung: 07.02.2026_
