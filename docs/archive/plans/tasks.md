...
| Problem                     | Datei                                   | Zeile  |
| --------------------------- | --------------------------------------- | ------ |
| Admin Password im Plaintext | `scripts/setup/setup_dev.sh`            | 68     |
| JWT Secret im Plaintext     | `scripts/setup/setup_dev.sh`            | 128    |
| Password in Shell History   | `scripts/security/generate_htpasswd.sh` | 31, 54 |
...
- [x] `apps/dashboard-frontend/.dockerignore`
...
| --------------------------------------------------------- | ------------------------------------------ | -------------- |
| `apps/dashboard-frontend/src/components/Chat.js`          | Durch ChatMulti.js ersetzt                 | None           |
