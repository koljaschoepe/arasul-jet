...
- [ ] `./scripts/backup/backup.sh` ausgeführt
...
- [ ] SEC-C001: Passwort min 12 chars (`scripts/validate/validate_config.sh:144`)
...
- [ ] PostgreSQL: `./scripts/backup/restore.sh --latest`
...
./scripts/backup/restore.sh --list  # Verfügbare Backups
./scripts/backup/restore.sh --all --date YYYYMMDD  # Spezifisches Datum
```

---

_Vollständige Details: docs/MIGRATION_PLAN_JETSON.md_
