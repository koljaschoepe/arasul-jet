...
### 1.1 Dashboard-Backend README (apps/dashboard-backend/README.md)
...
### 1.2 Dashboard-Frontend README (apps/dashboard-frontend/README.md)
...
./scripts/backup/backup.sh [--type full|incremental]
...
_Plan erstellt durch Claude Code - Arasul Platform Analysis_
