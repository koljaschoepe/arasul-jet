...
| `system/`   | Runtime system management — boot guards, watchdogs, ordered startup.                                                                                  | `einheiten-installieren.sh`, `deadman-switch.sh`, `ordered-startup.sh`                     |
| `test/`     | Test runners + smoke / DR / integration / load tests.                                                                                                 | `run-tests.sh`, `smoke-test.sh`, `dr-drill.sh`, `integration-test.sh`                      |
| `util/`     | One-off utilities: notifications, support-log export, MCP server bring-up.                                                                            | `telegram-notify.sh`, `export-support-logs.sh`, `lizenz-geraet.sh`                         |
