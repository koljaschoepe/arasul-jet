...
BACKEND_MODULES="$PROJECT_ROOT/apps/dashboard-backend/node_modules"
FRONTEND_MODULES="$PROJECT_ROOT/apps/dashboard-frontend/node_modules"
...
# Check ESLint
if [ -f "apps/dashboard-backend/.eslintrc.json" ]; then
