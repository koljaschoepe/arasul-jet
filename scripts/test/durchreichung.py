...
ERLAUBTE_LUECKE = {
    "ADMIN_EMAIL",
    "ALLOWED_ORIGINS",
    "APPSTORE_MANIFESTS_DIR",
    "CLAUDE_LOGIN_EXEC_TIMEOUT_MS",
    "CLAUDE_TERMINAL_TIMEOUT",
    "CPU_CRITICAL_PERCENT",
    "CPU_WARNING_PERCENT",
    "DOCKER_GATEWAY_IP",
    "DOCUMENT_INDEXER_URL",
    "EXTENSIONS_BRUECKE_ENABLED",
    "EXTENSIONS_BRUECKE_TOKEN_TTL_MS",
    "EXTENSIONS_DIR",
    "EXTENSIONS_WATCH_INTERVAL_MS",
    ...
    "RATE_LIMIT_ENABLED",
    "SANDBOX_DATA_DIR",
    "SANDBOX_DEV_TEMPLATES_DIR",
    "SANDBOX_DOCKER_SOCK_GID",
    "SANDBOX_HOST_DATA_DIR",
    "SANDBOX_HOST_PROJECTS_DIR",
    "SANDBOX_HOST_REPO_DIR",
    "SANDBOX_HOST_TOOLS_DIR",
    "SEARXNG_URL",
    "SELF_HEALING_HOST",
    "SELF_HEALING_PORT",
    "SPACE_ROUTING_MAX_SPACES",
    "SPACE_ROUTING_THRESHOLD",
    "SSH_PORT",
    "SSH_USER",
    ...
    "VLLM_SERVICE_HOST",
    "VLLM_SERVICE_PORT",
    "WEB_LESEN_TIMEOUT_MS",
    "WEB_SUCHE_TIMEOUT_MS",
}
